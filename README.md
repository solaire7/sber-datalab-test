...
## Task2
Дополнил файл Dockercompose.
Для запуска Hive metastore предварительно необходимо создать базу Metastore
При запуске Hive metastore таблицы создаются.(результат на скриншоте 3.png)
Подружить Hive metastore с S3 хранилищем пока не удалось ((((
